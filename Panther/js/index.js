$(function(){
	...
	$('.game_start').click(function(){
		if(gotoPage==1){	
			location.href='hero1.html?openid='+openid+'&gotoPage='+gotoPage;
		}else if(gotoPage==2){	
			location.href='hero2.html?openid='+openid+'&gotoPage='+gotoPage;
		}else if(gotoPage==3){	
			location.href='hero3.html?openid='+openid+'&gotoPage='+gotoPage;
		}else if(gotoPage==4){	
			location.href='hero4.html?openid='+openid+'&gotoPage='+gotoPage;
		}else if(gotoPage==5){	
			location.href='hero5.html?openid='+openid+'&gotoPage='+gotoPage;
		}else if(gotoPage==6){	
			location.href='hero6.html?openid='+openid+'&gotoPage='+gotoPage;
		}
	})
	$('.jijie_btn').click(function(){
		$.ajax({
		   	url: './php/gather.php?openid='+openid+'&heroid=1',
		   	async: false,
		   	type: 'post',
